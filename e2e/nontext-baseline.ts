...
> = {
  ...
  "control-boundary|button#ideal-tamper-nudge.secondary-button": { ratio: 1.36, required: 3.0, unverified: false },
  "control-boundary|button#phone-toggle.secondary-button": { ratio: 1.37, required: 3.0, unverified: false },
  "control-boundary|button#share-combine-btn.secondary-button": { ratio: 1.37, required: 3.0, unverified: false },
  "control-boundary|button#share-reroll-btn.secondary-button": { ratio: 1.37, required: 3.0, unverified: false },
  "control-boundary|button#trace-reset.secondary-button": { ratio: 1.37, required: 3.0, unverified: false }
};
